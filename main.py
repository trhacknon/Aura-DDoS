...
def title():
    stdout.write("                                                                                          \n")
    stdout.write("                " + Fore.LIGHTRED_EX + "                          _____  _____        _____ \n")
    stdout.write("                " + Fore.LIGHTRED_EX + "     /\                  |  __ \|  __ \      / ____|\n")
    stdout.write("                " + Fore.LIGHTRED_EX + "    /  \  _   _ _ __ __ _| |  | | |  | | ___| (___  \n")
    stdout.write("                " + Fore.LIGHTWHITE_EX + "   / /\ \| | | | '__/ _` | |  | | |  | |/ _ \\___ \ \n")
    stdout.write("                " + Fore.LIGHTRED_EX + "  / ____ \ |_| | | | (_| | |__| | |__| | (_) |___) |\n")
    stdout.write("                " + Fore.LIGHTRED_EX + " /_/    \_\__,_|_|  \__,_|_____/|_____/ \___/_____/ \n")
    stdout.write("             " + Fore.LIGHTCYAN_EX + "        ══╦═════════════════════════════════╦══\n")
    stdout.write("             " + Fore.LIGHTCYAN_EX + "╔═════════╩═════════════════════════════════╩═════════╗\n")
    stdout.write(
        "             " + Fore.LIGHTCYAN_EX + "║ " + Fore.LIGHTWHITE_EX + "        Welcome To The Main Screen Of AuraDDoS " + Fore.LIGHTCYAN_EX + "     ║\n")
    stdout.write(
